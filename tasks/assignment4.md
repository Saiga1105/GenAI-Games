...
<div class="content-section">
    ...
    <div style="text-align: center; margin: 20px 0;">
        <img src="{{ '/tasks/assignment4/staal1.jpg' | relative_url }}" alt="Steel Frame Problem" style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
